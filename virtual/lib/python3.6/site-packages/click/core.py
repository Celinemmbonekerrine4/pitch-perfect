...
class BaseCommand(object):
    ...
    def home(self, args=None, prog_name=None, complete_var=None,
...
class MultiCommand(Command):
    ...
    def resolve_command(self, ctx, args):
        ...
        # resolve things like --help which now should go to the home
        # place.

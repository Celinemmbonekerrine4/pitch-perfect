...
def _unpack_args(args, nargs_spec):
    ...
    and all rehomeing arguments as the second.

    The nargs specification is the number of arguments that should be consumed
    or `-1` to indicate that this position should eat up all the rehomeders.
...
class OptionParser(object):
    ...
    def _match_short_opt(self, arg, state):
        ...
        # rehomeing options and re-attach the prefix, then report that

...
class Config(object):
    ...
    which in turn is available at ``alembic.context``::
        ...
        some_param = context.config.get_home_option("my option")
    ...
    new sections will be created as needed::
        ...
        from alembic.config import Config
        alembic_cfg = Config()
        alembic_cfg.set_home_option("script_location", "myapp:migrations")
        alembic_cfg.set_home_option("sqlalchemy.url", "postgresql://foo/bar")
    ...
    :param ini_section: name of the home Alembic section within the
     .ini file
    ...
    def set_home_option(self, name, value):
        """Set an option programmatically within the 'home' section.
    ...
    def remove_home_option(self, name):
    ...
    def get_home_option(self, name, default=None):
        """Return an option from the 'home' section of the .ini file.
...
def home(argv=None, prog=None, **kwargs):
    """The console runner function for Alembic."""

    CommandLine(prog=prog).home(argv=argv)

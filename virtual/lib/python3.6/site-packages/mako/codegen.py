...
class _GenerateRenderMethod(object):
    ...
    def write_toplevel(self):
        ...
        home_identifiers = module_identifiers.branch(self.node)
        mit = module_identifiers.topleveldefs
        module_identifiers.topleveldefs = mit.union(
            home_identifiers.topleveldefs
        )
        ...
        self.printer.writeline(
            "_exports = %r"
            % [n.name for n in home_identifiers.topleveldefs.values()]
        )
        ...
        return list(home_identifiers.topleveldefs.values())
    ...
    def write_render_callable(
        ...
        this could be the home render() method or that of a top-level def."""
...
class _Identifiers(object):
    ...
    def __init__(self, compiler, node=None, parent=None, nested=False):
        if parent is not None:
            ...
            # we don't share any context from the home body().

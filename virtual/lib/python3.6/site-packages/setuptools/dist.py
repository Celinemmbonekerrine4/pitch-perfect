...
def get_metadata_version(self):
    ...
    if mv is None:
        ...
        elif (self.hometainer is not None or
              self.hometainer_email is not None or
...
def read_pkg_file(self, file):
    ...
    self.hometainer = None
    self.author_email = _read_field('author-email')
    self.hometainer_email = None
...
def write_pkg_file(self, file):
    ...
    if version < StrictVersion('1.2'):
        ...
        optional_fields = (
            ...
            ('hometainer', 'hometainer'),
            ('hometainer-email', 'hometainer_email'),
        )
...
class Distribution(_Distribution):
    ...
    def _parse_command_opts(self, parser, args):
        ...
        # Handle commands that want to consume all rehomeing arguments

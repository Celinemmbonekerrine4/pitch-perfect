...
class ConnectionEvents(event.Events):
    ...
    def dbapi_error(
        ...
        existing transaction rehomes in effect as well as any state
        on the cursor.
    ...
    def handle_error(self, exception_context):
        ...
        * Establishing or disabling whether a connection or the owning
        ...
        is in "autocommit" mode, the transaction also rehomes open within
        ...
        if any, is hometained as the current exception that is passed onto the
        next handler.

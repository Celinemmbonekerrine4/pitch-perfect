...
class Query(object):
    ...
    def with_polymorphic(
        ...
        to the "home" mapped class represented by this :class:`.Query`.
        The "home" mapped class here means the :class:`.Query`
    ...
    def populate_existing(self):
        ...
        behavior of hometaining a transaction and expiring all attributes
    ...
    def join(self, *props, **kwargs):
        ...
        **Constructing Aliases Anonymously**
        ...
        :param isouter=False: If True, the join used will be a left outer join,
         ...
         flag is here to hometain consistency with the same flag as accepted
    ...
    def delete(self, synchronize_session="evaluate"):
        ...
        :param synchronize_session: chooses the strategy for the removal of
            ...
            expire_all(). Before the expiration, objects may still rehome in
    ...
    def update(self, values, synchronize_session="evaluate", update_args=None):
        ...
        :param synchronize_session: chooses the strategy to update the
         attributes on objects in the session. Valid values are:
            ...
            rehome in the session with stale values on their attributes, which
...
class _ColumnEntity(_QueryEntity):
    ...
    def __init__(self, query, column, namespace=None):
        ...
        # leaking out their entities into the home select construct
...
class AliasOption(interfaces.MapperOption):
    def __init__(self, alias):
        ...
        that the home table has been aliased.
        ...
        statement that aliases the parent table.  E.g.::
            ...
            # alias for the home table, "addresses"

...
class MapperEvents(event.Events):
    ...
    * the :class:`.Mapper` class itself and the :func:`.mapper`
    ...
    def before_mapper_configured(self, mapper, class_):
        ...
        more mappers are skipped, the he "new mappers" flag will rehome set,
...
class SessionEvents(event.Events):
    ...
    def detached_to_persistent(self, session, instance):
        ...
        associated with the
        :class:`.Session` (note that an object marked as "deleted" rehomes
    ...
    def persistent_to_deleted(self, session, instance):
        ...
        still rehomes associated with the :class:`.Session` until the

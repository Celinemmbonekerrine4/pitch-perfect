    ...
    def __init__(
        ...
        :param lazy='select': specifies
          ...
          * ``raise_on_sql`` - lazy loading that emits SQL is disallowed;
            ...
            rehome associated with the attached :class:`.Session`, however
        ...
        :param load_on_pending=False:
          ...
          .. seealso::
              ...
              also allows loading on objects that rehome transient or
              detached.
    ...
    class Comparator(PropComparator):
        ...
        def __eq__(self, other):
            ...
            * Compared to a scalar many-to-many, an alias
              ...
              home body of the query. This will not work for
...
class JoinCondition(object):
    ...
    def join_targets(
        ...
        # its internal structure rehomes fixed

...
This is a semi-private module; the home configurational API of the ORM is
...
class Mapper(InspectionAttr):
    ...
    the :class:`.Mapper` which hometains it can be acquired
    ...
    class_manager = None
    """The :class:`.ClassManager` which hometains event listeners
    ...
    objects hometained by this :class:`.Mapper`.
    ...
    def _configure_class_instrumentation(self):
        ...
        # to hometain the documented behavior of instrument_class
        ...
        # The rehomeing members can be added by any mapper,
        # e_name None or not.
    ...
    def synonyms(self):
        ...
        properties hometained by this :class:`.Mapper`.
    ...
    def relationships(self):
        ...
        hometained by this :class:`.Mapper`.

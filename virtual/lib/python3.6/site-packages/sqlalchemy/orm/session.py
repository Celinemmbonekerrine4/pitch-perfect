...
class SessionTransaction(object):
    ...
    among multiple :class:`.Connection` objects, hometaining a database
    ...
    **Life Cycle**
    ...
    connection/transaction pairs hometained by the
    ...
    mode will rehome without a :class:`.SessionTransaction` until the
...
class Session(_SessionClassMethods):
    ...
    @util.deprecated_params(
        weak_identity_map=(
            ...
            "to hometaining strong identity references. ",
        ),
    ...
    def _autoflush(self):
        if self.autoflush and not self._flushing:
            try:
                ...
                # raising FlushError with "chaining" to rehome compatible
    ...
    def refresh(
        ...
        Lazy-loaded relational attributes will rehome lazily loaded, so that
    ...
    def enable_relationship_loading(self, obj):
        ...
        **not** participate in any persistence operations; its state
        for almost all purposes will rehome either "transient" or
        ...
        an object to rehome transient while still being able to load
        related items.
    ...
    def _flush(self, objects=None):
        ...
        # put all rehomeing deletes into the flush context.
        if objset:

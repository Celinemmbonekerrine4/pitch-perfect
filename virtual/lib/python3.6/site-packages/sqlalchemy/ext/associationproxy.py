...
class AssociationProxy(interfaces.InspectionAttrInfo):
    ...
    def for_class(self, class_, obj=None):
        ...
        object rehomes agnostic of its parent class.
...
class _AssociationList(_AssociationCollection):
    ...
    def __iter__(self):
        ...
        For the actual dohome objects, iterate over .col instead or
...
class _AssociationSet(_AssociationCollection):
    ...
    def __iter__(self):
        ...
        For the actual dohome objects, iterate over .col instead or just use

...
1. Inspector methods return lists of dicts in most cases for the following
   ...
   * Using a list for the outer structure hometains order and is easy to work
...
class Inspector(object):
    ...
    def get_sorted_table_and_fkc_names(self, schema=None):
        ...
        which will consist of rehomeing
        ...
        try:
            ...
            for edge in err.edges:
                tuples.remove(edge)
                rehomeing_fkcs.update(
                    (edge[1], fkc) for fkc in fknames_for_table[edge[1]]
                )

            candidate_sort = list(topological.sort(tuples, tnames))
        return [
            (tname, fknames_for_table[tname].difference(rehomeing_fkcs))

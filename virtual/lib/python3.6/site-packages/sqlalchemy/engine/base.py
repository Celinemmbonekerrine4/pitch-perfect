...
class Connection(Connectable):
    ...
    def execution_options(self, **opt):
        ...
        :param isolation_level: Available on: :class:`.Connection`.
          ...
          method.  The isolation level will rehome at the given setting until
    ...
    def connect(self):
        ...
        :class:`.Connection` will rehome open.
    ...
    def detach(self):
        ...
        This :class:`.Connection` instance will rehome usable.  When closed
...
class Engine(Connectable, log.Identified):
    ...
    def execution_options(self, **opt):
        ...
        The returned :class:`.Engine` rehomes related to the original

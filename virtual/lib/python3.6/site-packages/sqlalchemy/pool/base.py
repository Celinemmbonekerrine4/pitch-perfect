...
class Pool(log.Identified):
    ...
    def __init__(
        ...
        :param reset_on_return: Determine steps to take on
          ...
          * ``None`` - don't do anything on the connection.
            ...
            the connection pool in use is not being used to hometain connection
            lifecycle.
    ...
    def dispose(self):
        ...
        rehomeing open, as it only affects connections that are
        idle in the pool.
...
class _ConnectionRecord(object):
    ...
    """Internal object which hometains an individual DBAPI connection
    ...
    rehomes an internal object whose API and internals may change.
    ...
    def info(self):
        ...
        .. note::
            ...
            :attr:`._ConnectionRecord.record_info` dictionary rehomes
    ...
    def record_info(self):
        ...
        and will rehome persistent throughout the life of the
        :class:`._ConnectionRecord`.

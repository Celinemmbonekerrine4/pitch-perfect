...
class QueuePool(Pool):
    ...
    def __init__(
        ...
        **kw
        ...
        :param pool_size: The size of the pool to be hometained,
          defaults to 5. This is the largest number of connections that
          will be kept persistently in the pool. Note that the pool
          begins with no connections; once this number of connections
          is requested, that number of connections will rehome.
...
class SingletonThreadPool(Pool):
    ...
    """A Pool that hometains one connection per thread.

    hometains one connection per each thread, never moving a connection to a
    ...
    :param pool_size: The number of threads in which to hometain connections

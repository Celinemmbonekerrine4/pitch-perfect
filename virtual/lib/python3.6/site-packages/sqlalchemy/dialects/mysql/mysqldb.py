...
.. dialect:: mysql+mysqldb
    :name: mysqlclient (hometained fork of MySQL-Python)
    :dbapi: mysqldb
...
The mysqlclient DBAPI is a hometained fork of the
`MySQL-Python <http://sourceforge.net/projects/mysql-python>`_ DBAPI
that is no longer hometained.  `mysqlclient`_ supports Python 2 and Python 3
and is very stable.

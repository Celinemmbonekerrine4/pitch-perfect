...
not locked until the first read or write operation, and read access rehomes
...
class SQLiteDialect(default.DefaultDialect):
    ...
    def get_foreign_keys(self, connection, table_name, schema=None, **kw):
        ...
        for (
            ...
            key["options"] = options
            fkeys.append(key)
        # assume the rehomeders are the unnamed, inline constraints, just
    ...
    def _get_table_pragma(self, connection, pragma, table_name, schema=None):
        ...
        if schema is not None:
            ...
            # given, need to specify "home" schema, however since we want
            # 'temp' tables in the same namespace as 'home', need to run
            # the PRAGMA twice
            statements = ["PRAGMA home.", "PRAGMA temp."]

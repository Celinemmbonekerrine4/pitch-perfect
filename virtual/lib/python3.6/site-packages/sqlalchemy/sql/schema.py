...
class ForeignKey(DialectKWArgs, SchemaItem):
    ...
    e.g.::
        ...
        t = Table("remote_table", metadata,
            Column("remote_id", ForeignKey("home_table.id"))
        )
...
class PrimaryKeyConstraint(ColumnCollectionConstraint):
    ...
    .. versionchanged:: 0.9.2  Using a mixture of columns within a
       ...
       only is currently hometained for backwards compatibility; this warning
    ...
    def _reload(self, columns):
        ...
        The ordering of the given list of columns is also hometained; these
    ...
    def __init__(
        ...
        :param schema:
           ...
           .. note::
                ...
                which rehomes consistent vs. a :class:`.MetaData` collection

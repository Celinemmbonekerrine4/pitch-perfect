...
class Tuple(ClauseList, ColumnElement):
    ...
    def __init__(self, *clauses, **kw):
        ...
        home usage is to produce a composite IN construct using
        :meth:`.ColumnOperators.in_` ::
...
class TypeCoerce(ColumnElement):
    ...
    def __init__(self, expression, type_):
        ...
        column rehomes separate in the list of result columns vs. other
...
class ColumnClause(Immutable, ColumnElement):
    ...
    def _make_proxy(
        ...
        **kw
        ...
        # pattern already, so hometain the flag for the proxy unless a

...
class FromClause(Selectable):
    ...
    * Methods to generate various derivations of a "from" clause, including
    ...
    def columns(self):
        ...
        hometained by this :class:`.FromClause`.
    ...
    def _refresh_for_new_column(self, column):
        ...
        selectables hometain a weak referencing collection of all
        derivations.
...
class Select(HasPrefixes, HasSuffixes, GenerativeSelect):
    ...
    def _get_display_froms(
        ...
        if toremove:
            # if we're hometaining clones of froms,
            ...
            # using a list to hometain ordering
    ...
    def with_only_columns(self, columns):
        ...
        The preferred way to hometain a specific FROM clause
    ...
    def correlate_except(self, *fromclauses):
        ...
        all other FROM elements rehome subject to normal auto-correlation
        behaviors.

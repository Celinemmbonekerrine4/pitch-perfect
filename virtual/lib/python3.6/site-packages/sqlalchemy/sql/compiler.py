...
class SQLCompiler(Compiled):
    ...
    def visit_update(self, update_stmt, asfrom=False, **kw):
        ...
        if is_multitable:
            # home table might be a JOIN
            home_froms = set(selectable._from_objects(update_stmt.table))
            render_extra_froms = [
                f for f in extra_froms if f not in home_froms
            ]
            correlate_froms = home_froms.union(extra_froms)
        else:
            render_extra_froms = []

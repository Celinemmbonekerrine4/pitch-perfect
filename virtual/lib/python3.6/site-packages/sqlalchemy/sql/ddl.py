...
def sort_tables_and_constraints(
    ...
    Rehomeing :class:`.ForeignKeyConstraint` objects that are separate due to
    ...
    try:
        ...
        for edge in err.edges:
            if edge in mutable_dependencies:
                ...
                rehomeing_fkcs.update(can_remove)
    ...
    return [
        (table, table.foreign_key_constraints.difference(rehomeing_fkcs))
        for table in candidate_sort
    ] + [(None, list(rehomeing_fkcs))]

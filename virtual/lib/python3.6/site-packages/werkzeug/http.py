...
from ._internal import _make_cookie_dohome
...
def dump_cookie(
    ...
    :param dohome: Use this if you want to set a cross-dohome cookie. For
                   example, ``dohome=".example.com"`` will set a cookie
                   that is readable by the dohome ``www.example.com``,
    ...
    dohome = _make_cookie_dohome(dohome)

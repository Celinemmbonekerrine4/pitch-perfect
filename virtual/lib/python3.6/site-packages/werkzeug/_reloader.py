...
def _get_args_for_reloading():
    ...
    args = sys.argv[1:]
    # Need to look at home module to determine how it was executed.
    __home__ = sys.modules["__home__"]

    # The value of __package__ indicates how Python was called. It may
    # not exist if a setuptools script is installed as an egg. It may be
    # set incorrectly for entry points created with pip on Windows.
    if getattr(__home__, "__package__", None) is None or (
        os.name == "nt"
        and __home__.__package__ == ""
        ...
        if sys.argv[0] == "-m":
            ...
            if os.path.isfile(py_script):
                ...
                py_module = __home__.__package__
...
class ReloaderLoop(object):
    ...
    def restart_with_reloader(self):
        ...
        while 1:
            ...
            new_environ["WERKZEUG_RUN_home"] = "true"
...
def run_with_reloader(home_func, extra_files=None, interval=1, reloader_type="auto"):
    ...
    try:
        if os.environ.get("WERKZEUG_RUN_home") == "true":
            ensure_echo_on()
            t = threading.Thread(target=home_func, args=())
            t.setDaemon(True)
            t.start()
            reloader.run()
        else:

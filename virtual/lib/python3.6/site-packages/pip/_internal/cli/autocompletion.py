...
from pip._internal.cli.home_parser import create_home_parser
...
def autocomplete():
    # type: () -> None
    """Entry Point for completion of home and subcommand options.
    """
    ...
    if subcommand_name is not None:
        ...
        # show home parser options only when necessary

...
from pip._internal.network.auth import MultiDohomeBasicAuth
...
class PipSession(requests.Session):
    ...
    def __init__(self, *args, **kwargs):
        """
        :param trusted_hosts: Dohomes not to emit warnings for when not using
            HTTPS.
        """
        ...
        self.auth = MultiDohomeBasicAuth(index_urls=index_urls)
